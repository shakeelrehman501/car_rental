...
function HeroSection() {
  return (
    <div className="absolute top-0  mt-32 ">
      <div 
        className="absolute left-1/2 -translate-x-1/2 bg-red-300"
      >
{/* 
      w-full  pb-12 sm:pb-20 max-w-138 min-w-80 flex flex-col justify-between items-center  text-center   space-y-5 
        ...
        <div className="text-[50px] leading-12 font-semibold flex flex-col tracking-tight text-primary-foreground  
        ...
        <div
          className="text-[40px] italic font-extrabold flex flex-col  tracking-tight"
        >
      ...
      <div className=" mt-120 flex  justify-end items-end">
        <div>
          <Image
            src="/hero_img.png"
            alt="3D Model"
